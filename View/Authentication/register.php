...
$registerText = ($role == "Employee") 
    ? "Sign up to find work that you want"
    : "Sign up to find talents that you need";
}
else {
  header('Location: /');
}
...
<form action="/register?r=<?php echo urlencode($role); ?>" method="POST" enctype="multipart/form-data">

    <div class="title pb-5">
<h1><?php echo $registerText ?></h1>
</div>
