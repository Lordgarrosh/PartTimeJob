...
public static function userRegister($email, $password, $fname, $mname, $lname, $profPic, $role) {
    $instance = new self();
        $instance->setConn();
...
public function createUser() {
    ...
    try {
        ...
        $stmt = $this->conn->prepare("INSERT INTO userinfo (Email, Password, FirstName, MiddleName, LastName, profPic, Number, Role) VALUES (:email, :password, :fname, :mname, :lname,  :profPic, :number, :role)");
       ...
       $stmt->bindValue(':number', $this->getProfPic());
